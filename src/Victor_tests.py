...
def ellipse(k, theta, R):
    ...
    vpar_bar = omega_b*kpar*light_speed**2/((kpar*light_speed)**2 + (harmonic*Omega_ce))
    
    Delta_vpar = light_speed*np.sqrt(((kpar*light_speed)**2 + (harmonic*Omega_ce)**2 - omega_b**2))*(harmonic*Omega_ce) \
